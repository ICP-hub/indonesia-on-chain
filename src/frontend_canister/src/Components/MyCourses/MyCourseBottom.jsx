      ...
      <div className="md2:hidden px-[25px]">
        ...
        <Tabs className="flex flex-col pt-[35px] bg-white rounded-lg">
          <TabList className="flex px-[5px] pb-[30px] pt-[10px] gap-5">
            ...
            <Tab
              className={`px-3 text-grey ${activeTab === 1 ? "text-purple-500 pb-5 border-b-2 border-purple-500" : ""}`}
              onClick={() => handleClick(1)}
            >
              Completed
            </Tab>
            <Tab
              className={`px-3 text-grey ${activeTab === 2 ? "text-purple-500 pb-5 border-b-2 border-purple-500" : ""}`}
      ...
      <div className="dxs:hidden md2:flex w-full pt-[35px]">
        <Tabs className="md2:flex flex-col pt-[25px] bg-white rounded-lg">
          <TabList className="flex px-[40px] pb-[30px] pt-[10px] gap-5">
            <Tab
              className={`px-5 text-grey ${activeTab === 0 ? "text-purple-500 pb-5 border-b-2 border-purple-500" : ""}`}
              onClick={() => handleClick(0)}
            >
              In Progress
            </Tab>
            <Tab
              className={`px-5 text-grey ${activeTab === 1 ? "text-purple-500 pb-5 border-b-2 border-purple-500" : ""}`}
              onClick={() => handleClick(1)}
            >
              {" "}
              Completed{" "}
            ...
            <Tab
              className={`px-5 text-grey ${activeTab === 2 ? "text-purple-500 pb-5 border-b-2 border-purple-500" : ""}`}
              onClick={() => handleClick(2)}
            >
              {" "}
              All{" "}
