...
const StudentSideBar = () => {
  ...
  return (
    <>
      ...
      <div className="hidden md:flex flex flex-col space-y-6 py-7 px-2 ">
        <div className="hidden md:flex flex flex-row justify-center items-center">
        ...
        <nav className="flex flex-col justify-center items-center w-full">
          <Link
            ...
            className="flex items-center py-2.5 px-4 rounded-lg transition duration-200 hover:bg-purple-500 "
          >
            <div className="flex "></div>
            <span className="ml-4 font-poppins font-[600] text-base text-[#696969]">
              Dashboard
            </span>
          </Link>
          <Link
          ...
          <Link
            to="/Certificates"
            className="flex items-center py-2.5 px-5 rounded-lg transition duration-200 hover:bg-purple-500 "
          >
            <div className=" ">
              <img src={Certificate} alt="" />
            </div>
            <span className="ml-5 font-poppins font-[600] text-base text-[#696969]">
              Certificates
            </span>
          </Link>
          <Link
          ...
          >
            <div className="">
              <img className="w-15 h-15 mr-8" src={Profile} alt="" />
            </div>
            <span className="mr-3 font-poppins font-[600] text-base text-[#696969]">
              Profile
            </span>
          </Link>
        </nav>
