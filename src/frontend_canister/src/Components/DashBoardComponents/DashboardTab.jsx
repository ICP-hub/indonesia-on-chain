    ...
    <div className="flex bg-[#e6f1fd]">
      <div className=" w-[100%] lg1:w-[72%]  flex flex-col md:flex">
        <div className="md:flex justify-between px-14 md2:pt-[25px] dxs:pt-[35px]">
          <p className=" md:flex md2:font-[600] font-[Segoe UI] md2:text-4xl text-[#2D6BE4] dxs:hidden">
            Dashboard
          </p>
          {/* Mobile View */}
          <div className="flex justify-between md2:hidden mt-[10px]">
            <p className=" md:flex dxs:text-[30px]  dxs:font-[500] md2:font-[600] font-[Segoe UI] md2:text-4xl text-[#2D6BE4]">
              Dashboard
            </p>
            <div className=" flex md:hidden justify-end pb-[45px]">
              <div className="pl-[16px]">
                <p className="font-[600] font-[Segoe UI] md2:text-[18px] dxs:text-[13px] text-[#00227A] leading-[17px] flex flex-row-reverse">
                  Name
                </p>
                <p className="font-[400] font-[Segoe UI] md2:text-[18px]  dxs:text-[13px]  text-[#8CA3C3] leading-[17px]">
                  123456789
                </p>
              </div>
              <img
                className="w-[57px] h-[45px] pl-[6px]"
                src="student.jpg"
                alt=""
              />
            </div>
