...
export function Play({ tooltipPlacement }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger>
        <PlayButton className="group ring-media-focus relative inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-md outline-none ring-inset hover:bg-white/20 data-[focus]:ring-4">
...
export function Mute({ tooltipPlacement }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger>
        <MuteButton className="group ring-media-focus relative inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-md outline-none ring-inset hover:bg-white/20 data-[focus]:ring-">
          {isMuted || volume == 0 ? (
...
export function Caption({ tooltipPlacement }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger>
        <CaptionButton className="group ring-media-focus relative inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-md outline-none ring-inset hover:bg-white/20 data-[focus]:ring-4">
          {isOn ? (
...
export function PIP({ tooltipPlacement }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger>
        <PIPButton className="group ring-media-focus relative inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-md outline-none ring-inset hover:bg-white/20 data-[focus]:ring-4">
          {isActive ? (
...
export function Fullscreen({ tooltipPlacement }) {
  ...
  return (
    <Tooltip.Root>
      <Tooltip.Trigger>
        <FullscreenButton className="group ring-media-focus relative inline-flex h-10 w-10 cursor-pointer items-center justify-center rounded-md outline-none ring-inset hover:bg-white/20 data-[focus]:ring-4">
          {isActive ? (
