    ...
    return (
        <div className="container px-4 py-5 mx-auto font-poppins rounded-xl">
            <div className="px-8 py-6 bg-white rounded-lg shadow-md">
                <h2 className="mb-4 text-2xl font-semibold">{t('SuggestedCourses')}</h2>
                <ul className="">
                    <li className="flex items-center justify-between py-4">
                        ...
                        <div className="flex-grow ml-4">
                            <h3 className="text-base font-medium">{t('BlockchainCourse')}</h3>
                            <p className="text-sm text-gray-600">{t('ByName')}</p>
                            <div className="flex items-center text-sm text-gray-500">
                                ...
                                <span className='ml-1'>{t('Rat')}</span>
                            </div>
                        </div>
                    </li>
                    <li className="flex items-center justify-between py-4">
