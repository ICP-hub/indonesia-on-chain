        ...
        <div className='container px-4 py-8 mx-auto font-poppins rounded-xl'>
            ...
            <div className="overflow-hidden bg-white rounded-lg shadow-md">
                <div className="flex items-center justify-between px-4 py-3">
                    <h3 className='text-xl font-bold'>{t('MyCourses.Publisher')}</h3>
                    <div className="flex items-center text-lg">
                        <span className="mr-2 text-sm text-gray-700">{t('MyCourses.ViewProfile')}</span>
                ...
                <div className="flex items-center justify-between px-4 py-3">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 className="text-xl font-bold">{t('MyCourses.Name')}</h2>
                            <p className="text-gray-500">{t('MyCourses.Publisher')}</p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 gap-4 p-4">
                    <p className='text-sm text-gray-700'>{t('MyCourses.yearsofexperience')}</p>
                    ...
                    <div className="flex items-center">
                        ...
                        <div>{t('MyCourses.EducatorRating')}</div>
                    </div>
