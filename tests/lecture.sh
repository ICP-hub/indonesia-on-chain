...
dfx canister call backend_content_canister addCourseLessons '("1717122456104758782", variant { Video = record { videoTitle ="Session 2: Blockchain Basics"; videobucket = "ioc-data"; videofile = "Session 2 - Blockchain Basics - HIRES.mp4"; videodescription = "<ul><li><strong>Key Topics:</strong><ul><li>Basics of blockchain: How it works</li><li>History and evolution of blockchain</li><li>Real-world applications beyond cryptocurrencies</li></ul></li><li><strong>Must Cover:</strong><ul><li>Understanding decentralization and its impact on businesses</li><li>Overview of major blockchain platforms, with an emphasis on ICP</li></ul></li></ul>"; videoduration = 600; viewcount = 100; }})';
